...
class Servisi extends PureComponent {
  ...
  goServisi = () => { this.props.push('/kontakt')}
    ...
    return (
      <div className="servisiContainer">
        ...
        <p className="intro">
          ...
          Ukoliko trebate redovan servis nemojte čekati. Nazovite nas na <a href="tel:385-5127-7009">+385 51 277 099 </a> i dogovorite Vaš servis još danas. Ukoliko želite, možete nas kontaktirati i putem web-a ili maila. <a onClick={this.goServisi}>Kliknite ovdje</a>.
        </p>
      </div>
    )
  }
